...
class StudentPages extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    switch (page) {
      ...
      case 'subjects':    return _Subjects();
      ...
      case 'materials':   return _Materials();
...
class _Dashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      appCard(ttRows([
        TtItem(time: '08:00', subject: 'Mathematics',  room: 'Room 204 · Mr. Hoang',
            status: 'Done',  barColor: AppColors.blue,
            badgeBg: const Color(0xFFF1F5F9), badgeColor: AppColors.text3),
        TtItem(time: '10:00', subject: 'English Lit.', room: 'Room 112 · Ms. Kim',
            status: 'Done',  barColor: AppColors.teal,
            badgeBg: const Color(0xFFF1F5F9), badgeColor: AppColors.text3),
        TtItem(time: '13:30', subject: 'Physics Lab',  room: 'Lab 2 · Dr. Vance',
            status: 'Next',  barColor: AppColors.navy,
            badgeBg: AppColors.blueLight, badgeColor: AppColors.blue),
        TtItem(time: '15:00', subject: 'History',      room: 'Room 308 · Mr. Osei',
            status: 'Later', barColor: AppColors.amber,
            badgeBg: const Color(0xFFF1F5F9), badgeColor: AppColors.text3),
      ])),
      secLabel('Due Soon'),
      appCard(asgnCards([
        ...
        AsgItem(sub: 'PHYSICS',     title: 'Chapter 5 Lab Report',
            due: '📅 Apr 6',    barColor: AppColors.teal),
        AsgItem(sub: 'ENGLISH',     title: 'Essay: The Great Gatsby',
            due: '📅 Apr 7',    barColor: AppColors.navy),
      ])),
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('87.4%', style: GoogleFonts.dmSerifDisplay(
                      fontSize: 26, color: AppColors.text1)),
                  Text('Overall Average · Term 2',
...
class _Timetable extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      appCard(ttRows([
        TtItem(time: '08:00', subject: 'Mathematics',      room: 'Room 204 · Mr. Hoang',
            status: '—', barColor: AppColors.blue,
            badgeBg: const Color(0xFFF1F5F9), badgeColor: AppColors.text3),
        TtItem(time: '10:00', subject: 'English Literature',room: 'Room 112 · Ms. Kim',
            status: '—', barColor: AppColors.navy,
            badgeBg: const Color(0xFFF1F5F9), badgeColor: AppColors.text3),
        TtItem(time: '13:30', subject: 'Physics Lab',       room: 'Lab 2 · Dr. Vance',
            status: '—', barColor: AppColors.teal,
            badgeBg: const Color(0xFFF1F5F9), badgeColor: AppColors.text3),
        TtItem(time: '15:00', subject: 'History',           room: 'Room 308 · Mr. Osei',
            status: '—', barColor: AppColors.amber,
            badgeBg: const Color(0xFFF1F5F9), badgeColor: AppColors.text3),
      ])),
      const SizedBox(height: 16),
    ],
      ...
      appCard(Column(children: [
        ...[
          ...
          child: Row(children: [
            Container(
              width: 38, height: 38,
              decoration: BoxDecoration(color: m.$5.withOpacity(0.15),
                  borderRadius: BorderRadius.circular(rSm)),
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(m.$1, style: GoogleFonts.plusJakartaSans(
                  fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.text1)),
              Text(m.$2, style: GoogleFonts.plusJakartaSans(
                  fontSize: 11, color: AppColors.text3)),
            ])),
