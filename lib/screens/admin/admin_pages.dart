...
class AdminPages extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    switch (page) {
      ...
      case 'students':  return _Students();
      case 'teachers':  return _Teachers();
      case 'users':     return _Users();
      case 'academic':  return _Academic();
      case 'grading':   return _Grading();
      case 'mapping':   return _Mapping();
      case 'parents':   return _Parents();
...
class _Dashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      statGrid([
        const StatItem(icon: '🎓', val: '1,240', label: 'Students',   delta: 5),
        const StatItem(icon: '📚', val: '84',    label: 'Teachers',   delta: 2),
        const StatItem(icon: '👥', val: '1,180', label: 'Parents',    delta: 0),
        const StatItem(icon: '✅', val: '94%',   label: 'Attendance', delta: 1),
      ]),
      secLabel('Quick Actions'),
      actionGrid([
        ActionItem(icon: '🎓', label: 'Add Student',   bg: AppColors.blueLight),
        ActionItem(icon: '📚', label: 'Add Teacher',   bg: AppColors.tealLight),
        ActionItem(icon: '👥', label: 'Add Parent',    bg: AppColors.greenLight),
        ActionItem(icon: '🔑', label: 'Manage Roles',  bg: AppColors.amberLight),
        ActionItem(icon: '📅', label: 'Academic Year', bg: AppColors.blueLight),
        ActionItem(icon: '⭐', label: 'Grading',       bg: AppColors.redLight),
      ]),
    ...
    children: [
      ...
      appCard(Column(children: [
        ...[
          ...
          return listItem(
            av: initials, avBg: AppColors.avNavy, avColor: AppColors.navy,
      ...
      Padding(
        ...
        child: navyBtn('+ Create Student Profile'),
      ),
      const SizedBox(height: 16),
    ],
  );
...
class _Teachers extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      appCard(Column(children: [
        ...[
          ('Dr. Elena Vance', 'Science',     AppColors.avTeal,  AppColors.teal, 'Sci'),
          ('Mr. James Hoang', 'Mathematics', AppColors.avBlue,  AppColors.blue, 'Math'),
          ('Ms. Sarah Kim',   'English',     AppColors.avNavy,  AppColors.navy, 'Eng'),
          ('Mr. David Osei',  'History',     AppColors.avAmber, AppColors.amber,'Hist'),
        ].map((t) => listItem(
          av: t.$1.split(' ').last[0],
          avBg: t.$3, avColor: t.$4,
          name: t.$1, sub: t.$2,
          badgeText: t.$5,
      ...
      Padding(
        padding: const EdgeInsets.fromLTRB(14, 0, 14, 8),
        child: navyBtn('+ Create Teacher Profile'),
      ),
      const SizedBox(height: 16),
    ],
  );
    ...
    children: [
      ...
      appCard(Column(children: [
        ...[
          ...
          name: r.$1, sub: r.$2,
          badgeText: 'Edit',
          badgeBg: r.$3, badgeColor: r.$4,
        )),
      ])),
      Padding(
        padding: const EdgeInsets.fromLTRB(14, 0, 14, 8),
        child: navyBtn('+ Create Custom Role'),
      ),
      const SizedBox(height: 16),
    ],
  );
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('2024–2025',
                    style: GoogleFonts.dmSerifDisplay(fontSize: 17, color: AppColors.text1)),
              ...
              ...bands.map((b) => TableRow(
                ...
                children: [
                  Padding(padding: const EdgeInsets.all(10),
                      child: appBadge(b.$1, bg: b.$4, color: b.$5)),
                  Padding(padding: const EdgeInsets.all(10),
                      child: Text(b.$2, style: GoogleFonts.plusJakartaSans(fontSize: 11, color: AppColors.text2))),
                  Padding(padding: const EdgeInsets.all(10),
                      child: Text(b.$3, style: GoogleFonts.plusJakartaSans(fontSize: 12, color: AppColors.text1))),
                ],
              )),
            ],
          ),
    ...
    children: [
      ...
      appCard(Column(children: [
        ...[
          ...
          av: '👥', avBg: AppColors.amberLight, avColor: AppColors.amber,
    ...
    children: [
      ...
      appCard(Column(children: [
        ...[
          ...
          av: p.$1.split(' ').map((x) => x[0]).join(''),
          avBg: AppColors.amberLight, avColor: AppColors.amber,
          name: p.$1, sub: p.$2,
          badgeText: 'Active',
