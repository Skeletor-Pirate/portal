...
const Map<UserRole, RoleConfig> kRoles = {
  ...
  UserRole.admin: RoleConfig(
    ...
    nav: [
      NavItem(id: 'dashboard', label: 'Dashboard', iconName: 'dashboard'),
      NavItem(id: 'academic', label: 'Academic Years', iconName: 'academic'),
      ...
      NavItem(id: 'grading', label: 'Grading Remarks', iconName: 'grading'),
  ...
  UserRole.teacher: RoleConfig(
    ...
    nav: [
      ...
      NavItem(id: 'exams', label: 'Exams', iconName: 'exams'),
      NavItem(id: 'timetable', label: 'My Timetable', iconName: 'timetable'),
      NavItem(id: 'analytics', label: 'Student Analytics', iconName: 'analytics'),
      NavItem(id: 'profile', label: 'Settings', iconName: 'profile'),
    ],
    bottom: [
      NavItem(id: 'dashboard', label: 'Dash', iconName: 'dashboard'),
