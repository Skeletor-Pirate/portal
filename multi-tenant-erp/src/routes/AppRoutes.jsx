...
import Enrollments from '../pages/schoolAdmin/Enrollments';
...
import AccountantFeeStructure from "../pages/accountant/FeeStructure";
import AccountantReconcile from "../pages/accountant/Reconcile";
import AccountantManualPay from "../pages/accountant/ManualPay";
...
function RootRedirect() {
  ...
  try {
    ...
    if (lowerRole.includes('accountant')) return <Navigate to="/accountant" replace />;
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/school-admin/enrollments" element={<Enrollments />} />
        ...
        <Route path="/accountant/reconcile" element={<AccountantReconcile />} />
        <Route path="/accountant/manual-pay" element={<AccountantManualPay />} />
...
<Route path="/parent/payments" element={<ParentProvider><ParentPayments /></ParentProvider>} />
<Route path="/parent/insights" element={<ParentProvider><AllInsightsRecommendations /></ParentProvider>} />
