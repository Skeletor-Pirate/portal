...
function AccountantLayoutInner({ children, title = "Dashboard" }) {
...
export default function AccountantLayout({ children, title }) {
  return (
    <ThemeProvider>
      <AccountantLayoutInner title={title}>{children}</AccountantLayoutInner>
    </ThemeProvider>
  );
}